...
class MyCounterTest {
  ...
  @Test
  void test_using_parallelStream() {
    int count = 10;
    myCounter.init();
  ...
  @Test
  void test_error_using_parallelStream() {
    int count = 10;
    myCounter.init();
  ...
  @Test
  void test_using_executorService() throws InterruptedException {
    int count = 10;
    myCounter.init();
  ...
  @Test
  void test_using_forkJoinPool() throws InterruptedException {
    int count = 10;
    myCounter.init();
