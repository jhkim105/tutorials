...
@EnableJpaRepositories(basePackages = {"jhkim105.tutorials.multitenant.repository"},
...
public class TenantDatabaseConfig {
  ...
  public LocalContainerEntityManagerFactoryBean tenantEntityManagerFactory(
    ...
    entityManagerFactoryBean.setPackagesToScan("jhkim105.tutorials.multitenant.domain");
