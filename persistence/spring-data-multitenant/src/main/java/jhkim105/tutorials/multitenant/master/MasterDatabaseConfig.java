package jhkim105.tutorials.multitenant.master;
...
@EnableJpaRepositories(basePackages = "jhkim105.tutorials.multitenant.master.repository",
...
public class MasterDatabaseConfig {
  ...
  public LocalContainerEntityManagerFactoryBean masterEntityManagerFactory(EntityManagerFactoryBuilder builder) {
    return builder.dataSource(masterDataSource())
        .packages("jhkim105.tutorials.multitenant.master.domain")
